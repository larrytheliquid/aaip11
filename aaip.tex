...
theorem provers that could be used to prove correctness properties
...
Thanks to totality of the language, any ``value level'' function can also be
used in type signatures to compute more precise typing requirements
(without running into undecidability of type-checking issues). 
